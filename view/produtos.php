		...
		<div class="container">
			...
			<div class="row">
				<ul class="nav nav-tabs nav-justified">
					<li role="presentation" class="active"><a href="produtos.php">Cadastrar Produtos</a></li>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<!--	<label>Quantidade</label>
						...
						<p></p>
						<span id="btnAddProduto" class="btn btn-primary btn-block">Adicionar</span>
					</form>
				</div>
				<div class="col-sm-8">
	...
	<script type="text/javascript">
		function adicionarProduto(idproduto){
			...
			$.ajax({
				...
				url:"../procedimentos/produtos/obterProdutos.php",
				success:function(r){
		...
		function deletarProduto(idproduto){
			alertify.confirm('Deseja Excluir este Produto?', function(){ 
				$.ajax({
					type:"POST",
					data:"idproduto=" + idproduto,
					url:"../procedimentos/produtos/deletarProdutos.php",
					success:function(r){
						if(r==1){
