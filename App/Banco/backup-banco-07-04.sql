...
CREATE TABLE `produto` (
  ...
  CONSTRAINT `fk_produto_imagem` FOREIGN KEY (`id_imagem`) REFERENCES `imagem` (`id_imagem`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2022-04-07 16:58:04
